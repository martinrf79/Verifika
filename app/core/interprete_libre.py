...
async def procesar_interprete_libre(user_id: str, raw_message: str,
    ...
    # CERTIFICADOR DE MODELO PUNTUAL — corre ANTES de las curadas: la
    # identidad del modelo preguntado la decide el CODIGO (regla cero), no
    # una curada generica ni el modelo. Visto vivo 20-jul: la curada de
    # disponibilidad agarraba el turno de Asus y la Dell G15 real del
    # catalogo nunca se ofrecia.
    ...
    try:
        ...
        _cur = (None if respuesta_curada_servida else
                servir_curada(raw_message, interp, estado,
