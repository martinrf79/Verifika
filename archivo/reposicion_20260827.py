# SNAPSHOT FICHA 34, 28-ago-2026. Salio de app/core/reposicion.py en el
# commit a6fff2f (origin/main al arrancar esta sesion). No corre. app/
# no importa este archivo. Ver archivo/README.md.
