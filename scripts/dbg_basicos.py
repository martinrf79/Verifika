"""Flujos basicos que el camino viejo resolvia por codigo y el nuevo apago.
catalogo -> listar categorias reales. nueva compra -> reset limpio (no puente,
no escalado). chitchat -> redactor, no puente."""
