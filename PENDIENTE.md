...
- **ABIERTO** · "Agregá un teclado a ese presupuesto" rehace la cuenta con SOLO el teclado y pierde los seis items de antes: sale Subtotal $12.000 con tres envíos de $24.000. Visto en el casete `80_charla_real_12ago` turno 8. El carrito vigente está en la memoria; la herramienta no lo suma cuando el modelo declara solo lo nuevo.
- **ABIERTO** · El pedido por categoría cambia de producto entre turnos: "2 mouse" salió Genius DX-110 en un turno y Genius + Logitech M170 en el siguiente, y los auriculares pasaron de Negro a Blanco sin que el cliente dijera nada. Mismo casete, turnos 6 y 7. El carrito guarda el id; la re-declaración por categoría lo pisa.
- **ABIERTO** · El tope de largo del piso subió de 1.591 a 1.763 caracteres al entrar la charla real del 12-ago, que es la más pesada que se grabó. No es una regresión: es el número real de hoy. Es el primero que tiene que bajar cuando se ataque la prioridad 2 (concisión).
