...
- **ABIERTO** · **FICHA 55 · EL RUTEO ES DEL MOTOR, NO DEL MODELO.** La unidad nueva, abierta el 16-sep: el modelo llena una planilla plana con las palabras del cliente y el codigo rutea cada renglon con las certificaciones que YA existen y hoy corren tarde. Es la decision 1 del 19-ago, hecha chica. La ficha tiene los siete conflictos con su arreglo, las seis reglas contra la cascada y el numero que la mide: la consistencia entre turnos, hoy cero de tres.
...
- **ABIERTO** · **LA GUARDA DE ESTADO NO EXISTE: el bot niega datos que la fuente TIENE.** Medido dos veces, 15 y 16-sep: contesto que no tiene el pais de fabricacion con el campo cargado en 880 de 880 y viajando en el tablero. La guarda de `numeros` mira cifras, no afirmaciones. La condicion tiene que ser de ESTADO: si ninguna consulta del turno toco ese campo, no se puede negar. **Es el conflicto 4 de la FICHA 55 y es lo proximo que duele.**
