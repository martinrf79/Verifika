...
- **ABIERTO** · **D16 · FAMILIA B: EL NOMBRE DEL RUBRO LE ROBA EL CAMPO AL PRECIO.** 54 de 59, medido con `python3 banco_pruebas/barrido_orden.py`, offline y gratis. "El teclado mas barato" ordena por `switch_teclado`, y lo mismo pasa en 5 de las 22 categorias. La familia A —nueve frases que salian al reves— cerro el 11-sep y el piso subio de 45 a 54. Vara en `tests/test_barrido_orden.py`.
