...
- **ABIERTO** · **YA HAY NUMERO REAL DE OMISION Y ES PEOR, COMO SE ANUNCIO: 43 de 243 puntos sin contestar, 18%, contra 22 de 206 (11%) de ayer. NO es una regresion, es la verdad apareciendo** — las preguntas informativas ahora abren punto, asi que aparecen los que siempre estuvieron sin contestar. Lo que queda abierto es bajarlo. La FICHA 08 ya lo desarmo: cada punto sale con su `estado` —RESUELTO, AMBIGUO, NO_SE_SABE, CONFLICTO, o VACIO que es la omision pelada—, asi que el 18% deja de ser una bolsa donde tres de cuatro casos no son un defecto. **Lo que todavia no frena nada es la puerta: eso es la FICHA 09, `puede_salir`.** El numero de SIN_ESTADO recien se lee corriendo las charlas con el censo nuevo.
