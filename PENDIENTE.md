...
- **ABIERTO** · **D16 · LA RESTRICCION EN PROSA SE TRADUCE AL ORDEN EQUIVOCADO.** 45 de 59 frases, medido con `python3 banco_pruebas/barrido_orden.py`, offline y gratis. Nueve salen AL REVES -"el de precio mas bajo", "el mejor precio", "la garantia mas corta" ordenan de mayor a menor- y cinco de las 22 categorias le roban el campo al precio -"el teclado mas barato" ordena por `switch_teclado`-. Encontrada con la sonda el 11-sep: la interpretacion salio BIEN y el bot igual ofrecio un teclado de $512.500 con el mas barato a $12.000. Vara puesta y en rojo en `tests/test_barrido_orden.py`.
