...
- **A MEDIAS** · El nexo interpretación-respuesta ya ata por EVIDENCIA y no por parecido de palabras: los puntos sin atender en el texto final bajaron de 12,6% a 1,0% sobre las charlas grabadas, y el único que queda es real. Falta la pieza 3, el contrato NO_OMITE: hoy la señal es confiable pero nadie actúa sobre ella al final del turno.
