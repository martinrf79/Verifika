...
- **ABIERTO** · **FICHA 54 · LOS SEIS PASOS ESTAN HECHOS Y NINGUNO TIENE CORRIDA VIVA TODAVIA.** A los cuatro del 15-sep se sumaron dos: los ocho campos de si o no dicen `si` o `no` en vez de enumerar su prosa -el tablero pasa de 2.653 a 2.457 tokens y viaja dos veces por turno-, y la cuenta certifica el nombre adentro, como la compatibilidad. **La tanda de hoy no midio nada:** 13 de 17 turnos volvieron SIN RESPUESTA con 503 y despues 429 de la clave gratis, asi que se para y se corre manana, sin cambiar a la paga. Lo que hay que mirar ahi: si `compatibilidad` y `criterio` por fin se declaran, si la cuenta sale en la PRIMERA vuelta, y si las vueltas por turno bajan de 2.82.
