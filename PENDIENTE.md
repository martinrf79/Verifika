...
- **A MEDIAS** · El barrido. Hechos los tres de la fuente: CATÁLOGO (`test_barrido_identidad`), FUENTE (`test_barrido_fuente`) y FAQ (`test_barrido_faq`, 31 choques ciegos a 0). **Falta el de geo completo**: hoy se barren los nombres cortos compuestos, no las 23 mil localidades.
