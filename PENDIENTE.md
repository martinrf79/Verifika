...
- **ABIERTO** · **La FICHA 10 dejo la salida en cuatro puertas SIN borrar una sola comprobacion:** las dieciocho siguen corriendo adentro. Lo que el plan habilitaba y no se hizo es borrar las nueve que no intervienen sobre el corpus —`cierre` entre ellas, que corre en los 54 turnos y no mueve el texto en ninguno—, y sigue sin poder hacerse por el mismo motivo: el corpus no tiene un CBU falso ni un "sos un bot". Antes de borrar una hay que escribir el caso que la despierta, y los guiones 26 a 38 se escribieron para eso.
