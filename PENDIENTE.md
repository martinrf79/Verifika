...
- **ABIERTO** · **FICHA 54 · LOS CUATRO PASOS ESTAN HECHOS Y FALTA LA MEDICION JUNTA.** El 15-sep se cerraron los cuatro: los moldes fuera de las vueltas de buscar, la plata como una regla, `uso_recomendado` fuera del enum y la compatibilidad certificando adentro. Los dos primeros se midieron con `banco_pruebas/tanda_tablero.py` -81% a 93%-; **los dos ultimos NO tienen corrida viva todavia**, y se miden juntos en la proxima tanda. Lo que hay que mirar ahi: si `compatibilidad` por fin se declara, y si las vueltas por turno bajan de 2.82.
