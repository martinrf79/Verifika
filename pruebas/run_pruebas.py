...
async def main():
    ruta_dataset = os.path.join(os.path.dirname(__file__), "dataset_complejo.csv")
    ...
    ruta_informe = os.path.join(os.path.dirname(__file__), f"informe_complejo_{timestamp}.csv")
