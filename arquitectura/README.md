...
La orden de trabajo abierta es `FICHA_41_un_idioma.md`. La FICHA 36 corrió:
reposicion y guia_pedido salieron de `app/`. Los dos termómetros siguen.
...
| `FICHA_41_un_idioma.md` | **abierta**: un idioma, el del molde |
